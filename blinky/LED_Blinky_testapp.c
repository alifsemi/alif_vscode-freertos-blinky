 ...
 *           - HE core toggles LED0 and HP core toggles LED1 R -> G -> B
 * @bug      None.
 * @Note     None.
 ******************************************************************************/
...
void led_demo_Thread(void *pvParameters)
{
   ...
   *   - HE Core Blink LED0_R, then LED0_G, then LED0_B in rotation.
   *   - HP Core Blink LED1_R, then LED1_G, then LED1_B in rotation.
   */
